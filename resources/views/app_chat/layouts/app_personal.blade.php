...
<head>
    ...
    @vite('resources/js/pages/app_chat/app_personal.js')
</head>
<body>
        ...
        <div class="main-container">
          ...
          <div class="cover-photo-container">
            <div class="cover-photo">
                <div class="add-cover-btn" onclick="toggleCoverMenu()">
                    <i class="fas fa-camera"></i> Thêm ảnh bìa
                </div>

                <div id="cover-menu" class="cover-menu hidden">
                    <div class="menu-item" onclick="openPhotoModal()">
                        <i class="fas fa-image"></i> Chọn ảnh bìa
                    </div>
                    <div class="menu-item" onclick="uploadCoverPhoto()">
                        <i class="fas fa-upload"></i> Tải ảnh lên
                    </div>
                    <input type="file" id="uploadCoverInput" accept="image/*" hidden>
                </div>

                <!-- Thanh chỉnh sửa ảnh bìa -->
                <div id="cover-editor-bar" class="cover-editor hidden">
                    ...
                    <div class="editor-right">
                        <button class="cancel-btn" onclick="cancelCoverChange()">Hủy</button>
                        <button class="save-btn" onclick="saveCoverChange()">Lưu thay đổi</button>
                    </div>
                </div>
            ...
            <!-- 2. MODAL chọn ảnh ĐÈ LÊN TRANG -->
            <div id="photo-modal" class="modal hidden">
                <div class="modal-content">

                    <div class="modal-header">
                        <span class="modal-title">Chọn ảnh</span>
                        <span class="modal-close" onclick="closePhotoModal()">&times;</span>
                    </div>

                    <div class="modal-tabs">
                        <div class="tab active" onclick="switchTab(event, 'recent')">Ảnh gần đây</div>
                        <div class="tab" onclick="switchTab(event, 'album')">Album ảnh</div>
                    </div>

                    <div class="modal-body">
                        <div id="recent" class="tab-content active-tab">
                        </div>
            ...
            <div class="profile-section-wrapper">
                <div class="profile-info">
                    ...
                    <div class="profile-details">
                        <h1 class="profile-name">Lê Ngọc</h1>
                        <div class="friend-count">74 người bạn</div>
                    </div>
                    <div class="profile-actions">
                        <button class="btn btn-primary" onclick="goToStory()"><i class="fas fa-plus"></i> Thêm vào tin</button>
