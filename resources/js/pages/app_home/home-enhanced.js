...
// ============================================
import { createPostApi, uploadMediaFiles } from "../../services/post_service.js";
// ===== GLOBAL STATE =====
...
async function createPost() {
  ...
  //   // === GỌI API UPLOAD ===
  try {
    let data = await createPostApi(userId, text, 0, []);
    let uploadImg =  uploadMediaFiles(data.postId, selectedPostFiles);
    console.log("Created post:", data);
    console.log("Created post:", uploadImg);
  } catch (err) {
...
//   // === GỌI API UPLOAD ===
//   let data = await createPost(userId, text, 0, tagFriendIds);
//   console.log("Created post:", data);
...
function generatePostHTML(text, imageHtml) {
  return `
    <div class="post-header">
      <img src="${profile.backgroundImgUrl}" alt="" class="post-avatar">
